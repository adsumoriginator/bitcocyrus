                            ...
                            <div class="dataTables_wrapper form-inline dt-bootstrap">
                                ...
                                <div class="row">
                                    ...
                                    <table id="faqData" class="table table-striped table-bordered table-hover">
                                        ...
                                        <tbody>
                                            <?php $ii = 0; 
                                            if(isset($ipadd) && !empty($ipadd)) {
                                                foreach ($ipadd as $value) { $ii++;
                                            ?>
                                            <tr>
                                                <td><?php echo $ii; ?></td>
                                                ...
                                                <?php } ?>
                                                        ...
                                                        <td>
                                                            ...
                                                            <a href="<?php echo base_url(); ?>boip/change_status/<?php echo insep_encode($value->id); ?>" title="Edit">
                                                                <img src="<?php echo base_url(); ?>assets/admin/images/ip_status.png"  width="19px"  title="Edit"  />
                                                            </a>
                                                            <a title="Delete" href="<?php echo base_url(); ?>boip/delete/<?php echo insep_encode($value->id); ?>"onclick="return confirm('Are you sure want to delete ?');">

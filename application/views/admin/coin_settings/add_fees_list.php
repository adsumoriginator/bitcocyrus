    ...
    <div class="content-wrapper">
        <section class="content">
            ...
            ?>
                    ...
                    <div class="cm_head1">
                        <h3>Add Trade fees-<?php echo $trade_pair->trade_pair ?></h3>
                    </div>
                    ...
                    <div class="form-group row clearfix">
                          ...
                          <div class="col-sm-6 col-xs-12 cls_resp50">
                            ...
                            <input type="text"  name ="from_volume" class="form-control"   value="">
                          </div>
                    ...
                    <div class="form-group row clearfix">
                          ...
                          <div class="col-sm-6 col-xs-12 cls_resp50">
                            ...
                            <input type="text" name ="to_volume"  class="form-control"   value="">
                          </div>
                    ...
                    <div class="form-group row clearfix">
                          ...
                          <div class="col-sm-6 col-xs-12 cls_resp50">
                            ...
                            <input type="text"  name="maker_fee" class="form-control"  name ="maker"  value="">
                          </div>

                       
                    </div> 

                    <input type="hidden"  name="pair_id" value="<?php echo insep_decode($pair_id) ?>">
                    <div class="form-group row clearfix">
                          <div class="col-sm-6 col-xs-12 cls_resp50">
                            <label class="form-control-label">Taker fee </label>
                            <input type="text"   name="taker" class="form-control"   value="">
                          </div>

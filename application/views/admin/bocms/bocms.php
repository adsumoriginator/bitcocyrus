                                        ...
                                        <table id="cmsData" class="table m-0" style="border: 1px solid #cccccc;">
                                            ...
                                            <tbody>
                                                ...
                                                if(isset($getcmsPages) && !empty($getcmsPages)) {
                                                    foreach ($getcmsPages as $value) { $ii++;
                                                ?>
                                                <tr>
                                                    <td><?php echo $ii; ?></td>
                                                    ...
                                                    <td>
                                                        ...
                                                        <a href="<?php echo base_url(); ?>Bocms/editcms/<?php echo md5($value->id); ?>" class="editUser">

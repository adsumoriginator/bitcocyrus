        ...
        <div class="content-wrapper">
            <section class="content">
                <ul class="breadcrumb cm_breadcrumb">
                    ...
                    <!-- <li><a href="#">Property Page List</a></li> -->
                </ul>
                <div class="inn_content">
                    <form class="cm_frm1 verti_frm1">
                      <div class="cm_head1">
                        <h3>List of Features Pages</h3>
                      </div>
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="cm_tableh3 table-responsive">
                                        <table id="PropertyData" class="table m-0" style="border: 1px solid #cccccc;">
                                            <thead>
                                                <tr>
                                                    <th>#</th>       
                                                    <th>Features Name</th>
                                            ...
                                            <tbody>
                                                <?php $ii = 0; 
                                                if(isset($get_testiminial) && !empty($get_testiminial)) {
                                                    foreach ($get_testiminial as $value) { $ii++;
                                                ?>
                                                <tr>
                                                    <td><?php echo $ii; ?></td>       
                                                    ...
                                                    <td>     
                                                        <a href="<?php echo base_url(); ?>Bofeatures/editfeatures/<?php echo insep_encode($value->featureid); ?>" class="editUser">
                                                            <img src="<?php echo base_url(); ?>assets/admin/images/edit-icon.png" title="Edit"  />
                                                        </a>
                                                        <a href="<?php echo base_url(); ?>Bofeatures/deletefeatures/<?php echo insep_encode($value->featureid); ?>" class="deleteUser">

            ...
            ?>
                    ...
                    <div class="form-group row clearfix">
                          ...
                          <div class="col-sm-6 col-xs-12 cls_resp50">
                            ...
                            <input type="text"  class="form-control"   value="<?php echo $withdraw->username ?> " readonly>
                          </div>
                    ...
                    <div class="form-group row clearfix">
                          ...
                          <div class="col-sm-6 col-xs-12 cls_resp50">
                            ...
                            <input type="text" name="min_withdraw_limit" class="form-control"   value="<?php echo $withdraw->currency ?>" >
                          </div>
                       ...
                       <div class="form-group row clearfix">
                          ...
                          <div class="col-sm-6 col-xs-12 cls_resp50">
                            ...
                            <input type="text" name="max_withdraw_limit" class="form-control"   value="<?php echo $withdraw->total_amount ?>" >
                          </div>
                        ...
                        <div class="form-group row clearfix">
                          ...
                          <div class="col-sm-6 col-xs-12 cls_resp50">
                            ...
                            <input type="text" name="max_withdraw_limit" class="form-control"   value="<?php echo $withdraw->fee ?>" >
                          </div>
                    ...
                    <div class="form-group row clearfix">
                          ...
                          <div class="col-sm-6 col-xs-12 cls_resp50">                            <label class="form-control-label">Transfer Amount</label>
                            <input type="text" name="max_withdraw_limit" class="form-control"   value="<?php echo $withdraw->transfer_amount ?>" >
                          </div>
                          ...
                          <div class="col-sm-6 col-xs-12 cls_resp50">
                            ...
                            <input type="text" name="withdraw_fees" class="form-control"   value="<?php echo $withdraw->from_address ?>" >
                          </div>
                     ...
                     <div class="form-group row clearfix">
                          ...
                          <div class="col-sm-6 col-xs-12 cls_resp50">
                            ...
                            <input type="text" name="withdraw_fees" class="form-control"   value="<?php echo $withdraw->requested_time ?>" >
                          </div>
                     ...
                     <div class="form-group row clearfix">
                          ...
                          <div class="col-sm-6 col-xs-12 cls_resp50">
                            <label class="form-control-label">Approved  Time </label>
                            <input type="text" name="withdraw_fees" class="form-control"   value="<?php echo $withdraw->updated_time ?>" >
                          </div>

                ...
                <div class="inn_content">
                    ...
                    ?>                    
                        ...
                        <div class="cm_tablesc1 dep_tablesc mb-20">
                                ...
                                <div class="row">
                                 ...
                                 foreach($withdraw->result() as $row) {
                                            ...
                                            <tr>
                                              ...
                                              <td><?php echo $row->transation_hash?> </td>  
                            ...
                            <a title="Change user status" href="<?php echo base_url(); ?>BoAdmin_Transation/view_withdraw_detail/<?php echo insep_encode($row->transactionId); ?>"">

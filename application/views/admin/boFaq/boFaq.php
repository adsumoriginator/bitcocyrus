        ...
        <div class="content-wrapper">
            <section class="content">
                <ul class="breadcrumb cm_breadcrumb">
                    ...
                    <li>
                        <a href="<?php echo base_url()."BoFaq"; ?>">Manage FAQ</a>
                    </li>
                </ul>
                            ...
                            <div class="dataTables_wrapper form-inline dt-bootstrap">
                                ...
                                <div class="row">
                                    ...
                                    <table id="faqData" class="table table-striped table-bordered table-hover">
                                        ...
                                        <tbody>
                                            <?php $ii = 0; 
                                            if(isset($getFaq) && !empty($getFaq)) {
                                                foreach ($getFaq as $value) { $ii++;
                                            ?>
                                            <tr>
                                                <td><?php echo $ii; ?></td>
                                                ...
                                                <?php } ?>
                                                        ...
                                                        <td>
                                                            ...
                                                            <a href="<?php echo base_url(); ?>BoFaq/editFaq/<?php echo md5($value->id); ?>" title="Edit">
                                                                <img src="<?php echo base_url(); ?>assets/admin/images/edit-icon.png" title="Edit"  />
                                                            </a>
                                                            <a title="Delete" href="<?php echo base_url(); ?>BoFaq/deleteFaq/<?php echo md5($value->id); ?>"onclick="return confirm('Are you sure want to delete ?');">

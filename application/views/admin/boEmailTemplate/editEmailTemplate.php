    ...
    <div class="content-wrapper">
        <section class="content">
            <ul class="breadcrumb cm_breadcrumb">
                ...
                <li><a href="<?php echo base_url(); ?>BoEmailTemplate">Edit Email template </a></li>
            </ul>
            <div class="inn_content">
                <?php
                    $atrtibute = array('role'=>'form','name'=>'updateEmailTemplate','id'=>'updateEmailTemplate','method'=>'post','onSubmit'=>'return checkAll();','enctype' =>'multipart/form-data');
                    echo form_open('BoEmailTemplate/saveEmailTemplateDetails',$atrtibute);
                ?>
                <input type="hidden" name="mailID" id="mailID" value="<?php echo $mailID; ?>">
                    ...
                    <div class="form-group row">
                        <div class="col-sm-12 col-xs-12">
                            ...
                            <input type="text" class="form-control" id="mailName" name="mailName" placeholder="mail template name" value="<?php echo $mailName;?>">                                                        
                        </div>
                    </div>                    
                    <div class="form-group row">
                        <div class="col-sm-12 col-xs-12">
                            ...
                            <span class="mand_field">*</span>
                            <input type="text" class="form-control" id="mailSubject" name="mailSubject" placeholder="mail template subject" value="<?php echo $mailSubject;?>">                                                     
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="form-control-label">Mail content</label>
                        <span class="mand_field">*</span>
                        <textarea name="mailTemplate" class="ckeditor form-control" id="ckeditor"><?php echo $mailTemplate; ?></textarea>
                    ...
                    <li>
                        <input type="submit" name="updateEmailTemplate" value="Save changes" class="cm_blacbtn1">                        
                    </li>
                    <li>
...
<script src="<?php echo base_url();?>assets/admin/pageJS/editEmailTemplate.js"></script>

            ...
            ?>
                    ...
                    <div class="form-group row clearfix">
                          <div class="col-sm-6 col-xs-12 cls_resp50">
                            ...
                            <input type="text"  class="form-control"   value="<?php echo $support->category ?>"  readonly>
                          </div>                       
                    </div> 
                          ...
                          <div class="col-sm-6 col-xs-12 cls_resp50">
                            ...
                            ?>
                                ...
                                <select name="status" class="form-control">
                                  ...
                                  <option <?php if($status=="open"){ ?> selected="selected" <?php } ?>   value="open">Open</option>
                                  <option <?php if($status=="closed"){ ?> selected="selected" <?php } ?>   value="closed">Closed</option>

        ...
        <section class="content">
            ...
            <li>
                ...
                <li><a href="<?php echo base_url()."BoSupport_ticket/support_category"; ?>" >Support category </a></li>
                  <li><a>edit Support Category </a></li>
            </ul>
                ...
                ?>
                    ...
                    <div class="form-group row">
                        <div class="col-sm-6 col-xs-6">
                            ...
                            <input type="text" class="form-control"  required id="category_name" name="category_name" placeholder="Question" value="<?php echo $subcategory->category_name ?>">
                        </div>
                    </div>
                    <div class="form-group row">
					...
					<div class="col-sm-6 col-xs-6">
                        ...
                        <option <?php if($subcategory->status==1){?> selected="selected" <?php } ?> value="1">Active</option>
                        <option <?php if($subcategory->status==0){?> selected="selected" <?php } ?> value="0">In-Active</option>
                        </select>

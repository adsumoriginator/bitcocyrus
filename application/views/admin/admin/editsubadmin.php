...
<body class="hold-transition sidebar-mini">
                ...
                ?>
                    ...
                    <div class="form-group row">
                        <div class="col-sm-6 col-xs-6">
                            ...
                            <input type="text" class="form-control" id="username" name="username" placeholder="username" readonly value="<?php echo $admin_details->admin_name ?>">
                        </div>
                    </div>
                        ...
                        <div class="col-sm-6 col-xs-6">
                            ...
                            <span class="mand_field">*</span>
                            <input type="text" class="form-control" id="email" name="email" placeholder="Email Id" readonly  value="<?php echo $admin_details->bcc_email_id ?>">
                        </div>
                    </div>
                ...
                <div id="patternContainer"></div>
                   <input type="hidden" value="" name="patterncode" id="patterncode" />
                       ...
                       <div class="form-group row">
                        <div class="col-sm-6 col-xs-6">
                            ...
                            <span class="mand_field">*</span>  
                           <?php 
                              $status=$permission_details->user_details;
                           ?>

                           <select name="userdetaisls" class="form-control valid" >                

                           <option <?php if($status==0){?> selected="selected" <?php } ?>  value="0">Not allow</option>.
                            <option  <?php if($status==1){?> selected="selected" <?php } ?>  value="1">Allow</option>
                            </select>
                        </div>
                    </div>
                 ...
                 <div class="form-group row">
                        <div class="col-sm-6 col-xs-6">
                            ...
                            <span class="mand_field">*</span>
                                <?php 
                              $status=$permission_details->currency_details;
                           ?>
                 ...
                 <div class="form-group row">
                        <div class="col-sm-6 col-xs-6">
                            ...
                            <span class="mand_field">*</span>
                                ...
                                <?php 
                              $status=$permission_details->trade;
                           ?>
                    ...
                    <div class="form-group row">
                        <div class="col-sm-6 col-xs-6">
                            ...
                            <span class="mand_field">*</span>
                                ...
                                <?php 
                              $status=$permission_details->wallet;
                           ?>
                        ...
                        <div class="col-sm-6 col-xs-6">
                            ...
                            <span class="mand_field">*</span>
                                ...
                                <?php 
                              $status=$permission_details->deposit_withdraw;
                           ?>
                        ...
                        <div class="col-sm-6 col-xs-6">
                            ...
                            <span class="mand_field">*</span>
                                <?php 
                              $status=$permission_details->subscriper;
                           ?>
                       ...
                       <!--   <div class="form-group row">
                        <div class="col-sm-6 col-xs-6">
                            ...
                            <span class="mand_field">*</span>
                                <?php 
                              $status=$permission_details->support;
                           ?>
                    ...
                    <div class="col-sm-6 col-xs-6">
                            ...
                            <span class="mand_field">*</span>
                                ...
                                <?php 
                              $status=$permission_details->template;
                           ?>
    ...
    </div>  <!-- <footer class="main-footer"> Copyright © 2017 WCX Coin. All rights reserved. </footer>-->
</div>

...
<body class="hold-transition sidebar-mini">
    ...
    <div class="content-wrapper">
        ...
        <?php } ?>                    
            ...
            <?php 
            $form_attribute = array('role'=>'form','method'=>'post','id'=>'edit_withdraw','name'=>'edit_withdraw','class'=>'cm_frm1 verti_frm1'); 
    ...
    ?>			
                     ...
                     <div class="form-group row clearfix"> 
                        <div class="col-sm-6 col-xs-12 cls_resp50">
                          <label class="form-control-label">Withdraw Amount</label>
                    ...
                    <!--   <div class="col-sm-6 col-xs-12 cls_resp50 xrs_mat10">
                      ...
                      <div class="form-group row clearfix" id="xrp_tag_div" style="display:none"> 
                        <div class="col-sm-6 col-xs-12 cls_resp50">
                          <label class="form-control-label">Tag value</label>
                            <input type="text" class="form-control"  id="amount" name="xr">
                        </div>                                     
                    </div>  



                     <div class="form-group row clearfix" id="xmr_div" style="display:none"> 
                        <div class="col-sm-6 col-xs-12 cls_resp50">
